...
export const metadata: Metadata = buildMetadata({
  title: "Black Hairstyle LoRA — Stable Diffusion Fine-Tune",
  description:
    "A fine-tuned SDXL LoRA model trained on CC-licensed images of Black male hairstyles, labeled with culturally accurate names, published publicly on Replicate.",
  path: "/lora",
  image: "lora.webp",
})
...
export default function Lora() {
  return (
    <ProjectCard
      ...
      problem="Stable Diffusion's training data is racially skewed, like the data it was trained on. The model lacks accurate representation of Black male (amongst others) hairstyles and their cultural context."
